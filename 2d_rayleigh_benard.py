...
snapshots.add_task('dx(p)', name='grad_px',scales=1)
...
# scalar.add_task("inv_Vol*integ(u**2 + w**2)",  name='Eu(t)')
# scalar.add_task("inv_Vol*integ(b**2)"       ,  name='Eb(t)')

# scalar.add_task("nu*inv_Vol*integ( dx(u)**2 + uz**2 + dx(w)**2 + wz**2)",  name='dU^2(t)/Re')
# scalar.add_task("inv_Vol*integ(dx(b)**2 + bz**2)"                       ,  name='dB^2(t)'   )
...
# scalar.add_task("inv_Vol*integ(w*b)",  name='<wB>')
# scalar.add_task("inv_Vol*integ(b)"  ,  name='<B>' )
# scalar.add_task("inv_Vol*integ(z*b)",  name='<zB>')
