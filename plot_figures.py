...
#     plotter.plot_EBZ(term=r'\|\nabla B\|^2', figname='IC_E_BZ_and_f_BZ.png', Nlevels=50, sigma_smooth=.01)
...
#     plotter.plot_EBZ(term=r'\|\nabla B\|^2', figname='RBC_E_BZ_and_f_BZ.png', Nlevels=50, sigma_smooth=.01)
...
#     plotter.plot_EWZ(term=r'\|\nabla W \|^2', figname='HC_E_dW2_WZ_and_f_WZ.png', Nlevels=100, sigma_smooth=1)
...
#     plotter.plot_EWZ(term=r'\|\nabla W \|^2', figname='IC_E_dW2_WZ_and_f_WZ.png', Nlevels=30, sigma_smooth=1)
...
with open(Dir+'data/IC_pickled.pickle', 'rb') as f:
    ...
    plotter.plot_EWB(term=r'\|\nabla B\|^2', figname='IC_E_dB2_WB_and_f_WB.png', Nlevels=30, sigma_smooth=1)
    plotter.plot_EWB(term=r'\nabla W^T \nabla B', figname='IC_E_dWdB_WB_and_f_WB.png', Nlevels=30, sigma_smooth=1)
    plotter.plot_EWB(term=r'\|\nabla W \|^2', figname='IC_E_dW2_WB_and_f_WB.png', Nlevels=30, sigma_smooth=1)
...
with open(Dir+'data/RBC_pickled.pickle', 'rb') as f:
    ...
    plotter.plot_EWB(term=r'\|\nabla B\|^2', figname='RBC_E_dB2_WB_and_f_WB.png', Nlevels=30, sigma_smooth=1)
    plotter.plot_EWB(term=r'\nabla W^T \nabla B', figname='RBC_E_dWdB_WB_and_f_WB.png', Nlevels=30, sigma_smooth=1)
    plotter.plot_EWB(term=r'\|\nabla W \|^2', figname='RBC_E_dW2_WB_and_f_WB.png', Nlevels=30, sigma_smooth=1)
